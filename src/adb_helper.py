...
def execute_adb_shell_command2(adb_cmd, piped_into_cmd=None, ignore_stderr=False):
    return execute_adb_command2('shell %s' % adb_cmd, piped_into_cmd, ignore_stderr)


def execute_adb_command2(adb_cmd, piped_into_cmd=None, ignore_stderr=False):
